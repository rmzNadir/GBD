...
class PlanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plane" do
    assert_difference('Plane.count') do
      post planes_url, params: { plane: { capacidad: @plane.capacidad, cod_avion: @plane.cod_avion, fabricante: @plane.fabricante, modelo: @plane.modelo } }
    end
  ...
  test "should update plane" do
    patch plane_url(@plane), params: { plane: { capacidad: @plane.capacidad, cod_avion: @plane.cod_avion, fabricante: @plane.fabricante, modelo: @plane.modelo } }
